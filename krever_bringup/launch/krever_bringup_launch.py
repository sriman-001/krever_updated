# This launch file brings up the physical krever,
...
def generate_launch_description():
    ...
    pkg_path = FindPackageShare(package="krever_bringup").find("krever_bringup")
    pkg_description = FindPackageShare(package="krever_description").find(
        "krever_description"
    )
    pkg_teleop = FindPackageShare(package="krever_teleop").find("krever_teleop")
    pkg_navigation = FindPackageShare(package="krever_navigation").find(
        "krever_navigation"
    )
