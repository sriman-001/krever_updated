# Launch krever URDF file using Rviz
...
def generate_launch_description():
    ...
    pkg_path= FindPackageShare(package='krever_description').find('krever_description')
    rviz_config_path = os.path.join(pkg_path, 'rviz/description.rviz')
    urdf_model_path = os.path.join(pkg_path, 'urdf/krever.urdf.xacro')
